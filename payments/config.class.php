...
public function insert_b2b_response($TransactionID, $InitiatorAccountCurrentBalance,$DebitAccountCurrentBalance, $Amount, $DebitPartyAffectedAccountBalance, $TransCompletedTime, $DebitPartyCharges, $ReceiverPartyPublicName, $Currency){
	$conn = $this->connect();
	try{
