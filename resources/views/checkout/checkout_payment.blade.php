		                	...
		                	<div class="row">
		                		<div class="col-lg-9">
		                			<h2 class="checkout-title">Billing Details</h2><!-- End .checkout-title -->
	            						...
	            						<input value="{{Auth::user()->company}}" type="text" class="form-control">

	            						<label>Country *</label>
	            						<input value="{{Auth::user()->country}}" type="text" class="form-control" required>

	            						<label>Street address *</label>
	            						<input type="text" value="{{Auth::user()->address}}" class="form-control" placeholder="House number and Street name" required>
	            						<input type="text" value="{{Auth::user()->location}}" class="form-control" placeholder="Appartments, suite, unit etc ..." required>
                                        ...
                                        <label>Mobile *</label>
	        							<input type="email" value="{{Auth::user()->mobile}}" class="form-control" required>
