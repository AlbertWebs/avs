    ...
    <div class="header-dropdown-link">
        ...
        @if(Auth::check())
           ...
           <a href="{{url('/wishlist')}}" class="wishlist-link">
            ...
            <span class="wishlist-count"><?php $CountWishList = \javcorreia\Wishlist\Facades\Wishlist::count($UserID); echo $CountWishList; ?></span>
        ...
        <a href="{{url('/wishlist')}}" class="wishlist-link">
            <i class="icon-heart-o"></i>
            <span class="wishlist-count"><?php $CountWishList = \javcorreia\Wishlist\Facades\Wishlist::count($UserIP, 'session'); echo $CountWishList; ?></span>
            <span class="wishlist-txt">Wishlist</span>
        </a>
        @endif
        <?php
